        ...
        <div class="col-lg-12">
            <div class="card card-outline">
                <div class="card-header bg-blue d-flex justify-content-between align-items-center">
                    <h5 class="text-white m-b-0">{{ isset($technology->id) && $technology->id != 0 ? 'Update' : 'Create' }}
                        Technology</h5>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.technology.post') }}" enctype="multipart/form-data">
                        ...
                        <button type="submit"
                            class="btn btn-success">{{ isset($technology->id) && $technology->id != 0 ? 'Update' : 'Create' }}</button>
                    </form>
